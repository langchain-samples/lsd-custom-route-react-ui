...
export default function Auth() {
  ...
  if (supabaseConfigError) {
    return (
      <ConfigNotice
        ...
        message="Copy `frontend/.env.example` to `frontend/.env`, then set the Supabase browser credentials before loading the app."
        details={[
  ...
  if (confirmationSent) {
    return (
      <div className="flex h-dvh items-center justify-center bg-[var(--background)]">
        <div className="w-full max-w-sm rounded-xl border border-[var(--border)] bg-white p-8 shadow-md text-center">
          <svg
  ...
  return (
    <div className="flex h-dvh items-center justify-center bg-[var(--background)]">
      <div className="w-full max-w-sm rounded-xl border border-[var(--border)] bg-white p-8 shadow-md">
        {/* LangChain pinwheel mark */}
        ...
        <p className="mt-1 text-center text-sm text-[var(--muted-foreground)]">
          {mode === "login"
            ? "Sign in to continue"
            : "Create an account to start a new conversation"}
        </p>
